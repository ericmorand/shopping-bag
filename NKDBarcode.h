...
@property (getter=height,setter=setHeight:) float	height;
@property (getter=width,setter=setWidth:) float 	width;
@property (getter=checkDigit,setter=setCheckDigit:) char	checkDigit;
@property (getter=barWidth,setter=setBarWidth:) float	barWidth;
@property (getter=printsCaption,setter=setPrintsCaption:) BOOL	printsCaption;
@property (getter=captionHeight,setter=setCaptionHeight:) float	captionHeight;
@end
